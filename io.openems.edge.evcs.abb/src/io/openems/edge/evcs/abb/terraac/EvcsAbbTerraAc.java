...
public interface EvcsAbbTerraAc extends OpenemsComponent {
	...
	public enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		SET_CHARGING_CURRENT_LIMIT(Doc.of(OpenemsType.INTEGER).accessMode(AccessMode.READ_WRITE).unit(Unit.MILLIAMPERE).persistencePriority(PersistencePriority.HIGH).text("Set Charging Current Limit"), new UnsignedDoublewordElement(DEVICE_START_ADDRESS | 0x0100), ElementToChannelConverter.DIRECT_1_TO_1 ),
